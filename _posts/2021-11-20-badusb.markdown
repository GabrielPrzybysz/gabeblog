...
You can use programs like DuckerHunter, to monitor your typing speed, etc. When this type of typing attack occurs it is beyond human capacity, the program notices this and warns you when something like this occurs.
